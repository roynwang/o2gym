...
class CommentViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.commentlist = Comments(id: self.weiboid!)
        self.commentlist?.load(self.tableView.reloadData, itemcallback: nil)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        self.tableView.frame = CGRect(
            ...
            height: 50*20)
        // Configure the cell...
        let wb = self.commentlist?.datalist[indexPath.row] as! Weibo
