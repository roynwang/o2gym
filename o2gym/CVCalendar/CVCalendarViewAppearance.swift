...
class CVCalendarViewAppearance: NSObject {
    ...
    var dayLabelWeekdayFont: UIFont? = UIFont(name: "Avenir", size: 14)
    var dayLabelPresentWeekdayFont: UIFont? = UIFont(name: "Avenir", size: 14)
    var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 14)
    var dayLabelPresentWeekdayHighlightedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 14)
    var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 14)
    var dayLabelWeekdayHighlightedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 14)
    var dayLabelWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 14)
